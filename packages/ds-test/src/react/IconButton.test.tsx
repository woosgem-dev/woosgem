...
describe('IconButton', () => {
  ...
  describe('React 전용 props', () => {
    ...
    it('TC-R304: type이 명시되지 않으면 속성이 없다', () => {
      // IconButton은 기본 type을 설정하지 않음 (Button과 다름)
      render(<IconButton aria-label="Icon">X</IconButton>);
  ...
  describe('커스터마이즈 오버라이드', () => {
    ...
    it('TC-O133: 보호 속성 data-shape 오버라이드 차단', () => {
      // @ts-expect-error - 보호 속성 오버라이드 시도
  ...
  describe('기본값', () => {
    it('TC-C010: variant 기본값은 filled이다', () => {
      render(<IconButton aria-label="Icon">X</IconButton>);
      const btn = screen.getByRole('button');
    ...
    it('TC-C013: shape 기본값은 square이다', () => {
      render(<IconButton aria-label="Icon">X</IconButton>);
      const btn = screen.getByRole('button');
