...
describe('ListItem', () => {
  describe('core 일치 검증', () => {
    ...
    it('TC-R106: selected + disabled 동시 true일 때 selected 우선', () => {
  ...
  describe('이벤트 핸들러', () => {
    ...
    it('TC-R201: disabled 상태에서도 onClick이 호출된다 (li는 disabled 미지원)', async () => {
      const user = userEvent.setup();
      const handleClick = vi.fn();
  ...
  describe('커스터마이즈 오버라이드', () => {
    ...
    it('TC-O132: 보호 속성 data-divider 오버라이드 차단', () => {
      // @ts-expect-error - 보호 속성 오버라이드 시도
    ...
    it('TC-O133: 보호 속성 aria-selected 오버라이드 차단', () => {
      // @ts-expect-error - 보호 속성 오버라이드 시도
    ...
    it('TC-O134: 보호 속성 aria-disabled 오버라이드 차단', () => {
      // @ts-expect-error - 보호 속성 오버라이드 시도
  ...
  describe('기본값', () => {
    it('TC-C010: variant 기본값은 default이다', () => {
      render(<ListItem>Item</ListItem>);
      const item = document.querySelector('.list-item');
    ...
    it('TC-C011: selected 기본값은 false이다', () => {
      render(<ListItem>Item</ListItem>);
      const item = document.querySelector('.list-item');
    ...
    it('TC-C013: divider 기본값은 false이다', () => {
      render(<ListItem>Item</ListItem>);
      const item = document.querySelector('.list-item');
