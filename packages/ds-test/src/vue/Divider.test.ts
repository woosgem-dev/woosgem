...
describe('Divider', () => {
  describe('core 일치 검증', () => {
    ...
    it('TC-V104: role은 항상 separator이다', () => {
      render(Divider);
      const divider = screen.getByRole('separator');
  ...
  describe('커스터마이즈 오버라이드', () => {
    ...
    it('TC-O200: 보호 속성 data-orientation 오버라이드 차단', () => {
      render(Divider, {
        props: { orientation: 'vertical' },
    ...
    it('TC-O202: 보호 속성 data-spacing 오버라이드 차단', () => {
      render(Divider, {
        props: { spacing: 'lg' },
    ...
    it('TC-O204: 보호 속성 aria-orientation 오버라이드 차단', () => {
      render(Divider, {
        props: { orientation: 'vertical' },
