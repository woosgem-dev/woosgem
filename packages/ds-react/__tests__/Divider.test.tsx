...
import { Divider } from '@woosgem-dev/react';
...
describe('Divider', () => {
  describe('Core 일치 검증', () => {
    ...
    it('TC-R106: aria-orientationorientation기된(horizontal)', () => {
  ...
  describe('기본값', () => {
    it('TC-C010: orientation 기본값 horizontal다', () => {
      render(<Divider />);
      const divider = screen.getByRole('separator');
  ...
  describe('접근성', () => {
    ...
    it('aria-orientationorientation prop기된', () => {
