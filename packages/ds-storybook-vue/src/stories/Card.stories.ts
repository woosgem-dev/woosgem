  ...
  render: () => ({
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 16px; max-width: 600px">
        ...
        <Card padding="sm"><strong>Small:</strong> Compact padding for dense layouts</Card>
        <Card padding="md"><strong>Medium:</strong> Default comfortable spacing</Card>
        <Card padding="lg"><strong>Large:</strong> Spacious padding for emphasis</Card>
      </div>
    `,
  }),
};
  ...
  render: () => ({
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 16px; max-width: 600px">
        ...
        <Card padding="none">
          <CardHeader :divider="true" style="padding: 16px">
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 16px; max-width: 600px">
        ...
        <Card padding="none">
          ...
          <CardFooter :divider="true" align="end" style="padding: 12px 16px">
    ...
    template: `
      <div style="display: flex; flex-direction: column; gap: 16px; max-width: 600px">
        <Card padding="none">
          ...
          <CardFooter :divider="true" align="start" style="padding: 12px 16px">
        ...
        <Card padding="none">
          ...
          <CardFooter :divider="true" align="center" style="padding: 12px 16px">
        ...
        <Card padding="none">
          ...
          <CardFooter :divider="true" align="between" style="padding: 12px 16px">
...
export const RealWorldExample: Story = {
  ...
  render: () => ({
    ...
    template: `
      <div style="display: flex; gap: 16px; flex-wrap: wrap; max-width: 900px">
        <Card variant="outlined" padding="none" :hoverable="true" style="flex: 1 1 280px">
        ...
        <Card variant="elevated" padding="none" :hoverable="true" style="flex: 1 1 280px">
